        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar elevation='0px' position="fixed" open={open} style={{ backgroundColor: "white" }} >
                <Toolbar style={{ justifyContent: 'space-between', px: '0px !important' }}
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <AccountCircle sx={{ color: 'rgba(0, 0, 0, 0.6)', width: '40px', height: '40px', marginLeft: '20px' }} />
            ...
            <Drawer variant="permanent" open={open} className="sidebarclr"  >
                <DrawerHeader sx={{ justifyContent: 'space-between', px: '16px' }}>
                    ...
                    <LocalShippingOutlined color="inherit"
                    ...
                    <IconButton onClick={handleDrawerClose}>
                        {theme.direction === 'rtl' ? <ChevronRightIcon style={{ fontSize: "30px", color: 'white' }} /> : <ChevronLeftIcon style={{ fontSize: "30px", color: 'white' }} />}
                    </IconButton>
                ...
                <List sx={{ mr: '15px' }} >
                    <ListItemButton className='hoversidebar' sx={{ ':hover': { background: '#7D86A5' }, borderRadius: '0px 45px 47.5px 0px' }}>
                    ...
                    <ListItemButton onClick={handleClick} className='hoversidebar' sx={{ ':hover': { background: '#7D86A5' }, borderRadius: '0px 45px 47.5px 0px' }} >
                        <ListItemIcon sx={{ color: '#FFD600' }}>
                            <InboxIcon />
                        </ListItemIcon>
                        <ListItemText primary="Inbox" sx={{ color: 'white' }} />
                        {accordion ? <ExpandLess sx={{ color: '#FFD600' }} /> : <ExpandMore sx={{ color: '#FFD600' }} />}
                    </ListItemButton>

                    <Collapse in={accordion} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding  >
                            <ListItemButton className='hoversidebar' sx={{ pl: 4, ':hover': { background: '#7D86A5' }, borderRadius: '0px 45px 47.5px 0px' }} >
                                <ListItemIcon sx={{ color: '#FFD600' }}>
                                    <StarBorder />
                                </ListItemIcon>
            ...
            <Box sx={{ px: { xs: '24px', sm: '44px' } }} >
                ...
                <Box sx={{ py: { xs: '54px', sm: '24px' } }}>
                    <Typography >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        ...
                        dio morbi quis commodo odio aenean sed adipiscing.
                        Amet nisl suscipit adipiscing bibendum est ultricies integer quis.
                        Cursus euismod quis viverra nibh cras. Metus vulputate eu scelerisque felis imperdiet proin fermentum leo.
