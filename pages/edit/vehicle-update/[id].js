...
import { Add, Details, DoubleArrow } from '@material-ui/icons';
...
const VehicleUpdate = ({ vehicleType, vehicleData }) => {
    ...
    const vehicleDetails = vehicleData[0];
    const [vehicleId, setVehicleId] = useState(vehicleDetails.id);
    const vehicleStatus = [{ label: 'Active', }, { label: 'Deactive' }];
    ...
    const onSubmit = async (data) => {
        ...
        const res = await fetch(`${process.env.apiUrl}/update-vehicle/${vehicleId}`, {
            body: JSON.stringify({
                ...
                active_status: data.active_status.toLowerCase()
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <OutlinedInput
                                            ...
                                            defaultValue={vehicleDetails.vehicle_no}
                                            style={{
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <OutlinedInput
                                            ...
                                            defaultValue={vehicleDetails.vehicle_details}
                                ...
                                >
                                    ...
                                    >
                                        <Autocomplete
                                            ...
                                            className="autocomp1"
                                            id="combo-box-demo"
                                            options={vehicleType != null ? vehicleType : null}
                                            renderInput={(params) => (
                                                <TextField
                                                    {...params}
                                                    placeholder="--Select--"
                                        ...
                                        <Autocomplete
                                            ...
                                            renderInput={(params) => (
                                                <TextField
                                                    {...params}
                                                    placeholder="--Select--"
                                                    {...register('active_status', { required: true })}
                                                />
                                            )}
                                        />
                                    </Box>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <OutlinedInput
                                                ...
                                                defaultValue={vehicleDetails.owner_details[0].broker_name}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <TextareaAutosize
                                                ...
                                                defaultValue={vehicleDetails.owner_details[0].broker_address}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <OutlinedInput
                                                ...
                                                defaultValue={vehicleDetails.owner_details[0].broker_mobile}
...
export async function getServerSideProps(ctx) {
    ...
    if (session !== null && session !== undefined) {
        ...
        try {
            ...
            // fetch data of specific vehicle 
            const reqVehicle = await fetch(`${process.env.apiUrl}/vehicles/${vehicleId}`, {
                method: 'GET',
                headers: {
                    'Content-type': 'application/json',
                    Authorization: `Bearer ${token}`,
            ...
            const resVehicle = await reqVehicle.json();
            if (resVehicle.status === 'success') {
                vehicleData = resVehicle.data;
            }
        }
        catch (err) {
    ...
    return { props: { vehicleType, vehicleData } };
}
