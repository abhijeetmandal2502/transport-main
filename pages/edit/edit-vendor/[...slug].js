...
const VendorRegistration = ({ data }) => {
    ...
    const vendorNameTemp = queryParams[0].replace(/-/g, ' ');
    const vendorName = vendorNameTemp.replace(/\b\w/g, l => l.toUpperCase())
    const subVendorId = queryParams[1];
    ...
    const fetchData = async () => {
        try {
            const req = await fetch(`${process.env.apiUrl}/consignors/${subVendorId}`, {
                method: 'GET',
                headers: {
            ...
            if (res.status === 'success') {
                ...
                const tempArr = {
                    ...
                    city: resData.city,
                    consignor: resData.consignor,
                    country: resData.country,
                    email: resData.email,
                    cons_id: resData.cons_id,
                    pin_code: resData.pin_code,
                    mobile: resData.mobile,
                    name: resData.name,
                    state: resData.state,
                    gst: resData.gst_no,
                    status: resData.active_status.replace(/\b\w/g, l => l.toUpperCase()),
    ...
    const onSubmit = async (fromData) => {
        ...
        // submit to api call
        const req = await fetch(`${process.env.apiUrl}/update-consignor/${vendorData.id}`, {
            method: 'POST',
            headers: {
                'Content-type': 'application/json',
                Authorization: `Bearer ${token}`,
            ...
            body: JSON.stringify({
                ...
                active_status: fromData.status.toLowerCase()
            }),
        });
    ...
    return (Object.keys(vendorData).length > 0 ? <form onSubmit={handleSubmit(onSubmit)}>
        {' '}
        <BreadCrumb />
                            ...
                            >
                                ...
                                >
                                    ...
                                    <OutlinedInput
                                        ...
                                        defaultValue={vendorData.mobile}
                                        style={{
                                            width: '-webkit-fill-available',
                                            paddingLeft: 5,
                                            height: 36,
                            ...
                            >
                                ...
                                >
                                    ...
                                    <OutlinedInput
                                        ...
                                        defaultValue={vendorData.pin_code}
                                        style={{
                                            width: '-webkit-fill-available',
                                            paddingLeft: 5,
                                            height: 36,
