      ...
      >
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)' }}>
          <Item>
            ...
            >
              <InputLabel
                style={{ fontWeight: 'bold', color: 'black', fontSize: '11px' }}
              >
                NO.
              </InputLabel>
          ...
          <Item>
            <Typography style={{ textAlign: 'start', fontSize: '11px' }}>
              The Consignor has started that: he has not insured the consignment
              OR he has insured the Consignment
            </Typography>
            <FormGroup
              style={{
                flexDirection: 'row',
        ...
        >
          <Item sx={{ gridRow: '1', gridColumn: 'span 3' }}>
            ...
            <Input
              sx={{ width: '100%' }}
              style={{ fontSize: '11px' }}
              value={consignorAddress + ',     GST-' + data.consignor_gst_no}
              readOnly
            />
            <FormGroup
              style={{
            ...
            <Table aria-label="simple table">
              ...
              <TableBody id="invoicetbody">
                ...
                <TableRow>
                  <TableCell></TableCell>
                  <TableCell align="left">
                    <Typography >Date -  {biltyInfo.bitly_date}</Typography >
                  </TableCell>
                  <TableCell align="right"></TableCell>
                  <TableCell className="invoicelasttd" align="right">
                    Total
        ...
        >
          ...
          <Item sx={{ gridRow: '1' }} style={{ border: 'none' }}>
            <Box>
              <Typography
                style={{ textAlign: 'end', fontSize: '11px', marginRight: 8 }}
              >
